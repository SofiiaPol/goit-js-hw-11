...
`).join("");document.querySelector(".gallery").innerHTML=s},g=document.querySelector(".search-form"),a=document.querySelector(".loader");a.style.display="none";const y=o=>{o.preventDefault();const s=o.target;console.log(s.elements),console.log(s.elements.searchInput.value),d(s.elements.searchInput.value).then(e=>{a.style.display="none",e.totalHits===0?w("Sorry, there are no images matching your search query. Please try again!"):(h(e.hits),new c(".gallery a"))}).catch(e=>{a.style.display="none",b(e.message)})};g.addEventListener("submit",y);function b(o){i.show({title:"Error",message:o,messageColor:"white",backgroundColor:"tomato"})}function w(o){i.show({title:"Message",message:o,messageColor:"white",backgroundColor:"teal"})}
